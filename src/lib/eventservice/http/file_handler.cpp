...
bool file_handler::HandleRequest(AsyncHttpSocket::Ptr connect,
  ...
  if (!connect) {
    DLOG_ERROR(MOD_EB, "Async Http Socket is null");
    return false;
  }
