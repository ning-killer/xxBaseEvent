...
#define ASSERT_RETURN_FAILURE(condition, res) \
  if (condition) {DLOG_ERROR(MOD_EB, "ASSERT ("#condition") is true, then return "#res); return res;}
  //if (condition) {LOG(L_ERROR) << "ASSERT ("#condition") is true, then return "#res; return res;}

#define ASSERT_RETURN_VOID(condition) \
  if (condition) {DLOG_ERROR(MOD_EB, "ASSERT ("#condition") is true, then returned"); return;}
