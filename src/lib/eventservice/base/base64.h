...
#ifndef SRC_BASE_BASE64_H_KJ
#define SRC_BASE_BASE64_H_KJ
...
class Base64 {
 public:
  ...
  // Calculates the length of the encoded file
  // src_data_size:The length of the source file
  static uint32 CalcDstSize(uint32 src_data_size);
